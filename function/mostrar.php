...
while ($campos = mysql_fetch_array($tabla)) {
  echo "<div class=\"blq_4\">";
  echo "<table  align='center' ps_set_border_style(psdoc, style, width) >\n";
  echo "<tr>";
  echo "<td>Nombre: $campos[usu_nom]</td>";
  echo "</tr>\n";
  echo "<tr>";
  echo "<td>Teléfono: $campos[usu_tel]</td>";
  echo "</tr>\n";
  echo "<tr>";
  echo "<td>Dirección:$campos[usu_dir]</td>";
  echo "</tr>\n";
  echo "<tr>";
  echo "<td>Comuna:$campos[usu_com]</td>";
  echo "</tr>\n";
  echo "<tr>";
  echo "<td>E-mail: $campos[usu_email]</td>";
  echo "</tr>\n";
  echo "<tr>";
  echo "<td>Contraseña:$campos[usu_pass]</td>";
  echo "</tr>\n";
  echo "<tr>";
  echo "<td>Estado:$campos[usu_est]</td>";
  echo "</tr>\n";
