...
<html>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1.0" />
		<meta charset="utf-8">
		<title>ElpollitoPé - Contacto</title>
...
<?php
			...
			<div class="blq_6">
				<form action="function/contacto.php" method="POST" >
					<input class="inp_3" type="text" name="nombre" required><br>
					<input class="inp_3" type="email" name="email" required><br>
					<textarea class="inp_3" name="mensaje"></textarea><br>
